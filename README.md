...
- **Create Kubernetes Deployemtn file**  
  Make a file named 'rag-k8s.yaml' 
...
```bash
git config --global user.email "arpanchakraborty500.com"
git config --global user.name "arpanchakraborty23"
...
kubectl port-forward svc/rag-service 8501:80 --address 0.0.0.0
